    ...
    <div className="bg-[#071826] flex items-center justify-center">
      ...
      <div className="w-105 p-8 rounded-3xl border border-white/10 bg-linear-to-b from-[#0b1b2b] to-[#081423]">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="text-3xl animate-fish">
            🐟
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          {schedule.map((item, index) => (
            <div
              ...
              className="flex items-center justify-between p-4 rounded-2xl border border-white/10 bg-[#081423] cursor-pointer"
            >
        ...
        <button
          onClick={addSchedule}
          className="mt-6 w-full py-3 rounded-xl bg-cyan-500 text-black font-semibold"
        >
          + Tambah Jadwal
        </button>
...
<input
  ...
  className="bg-slate-800 text-white px-13.5 py-2 font-bold rounded outline-none"
/>
